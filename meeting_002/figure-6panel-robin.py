...
m1 = mcp.shade(xax,yax,sst[56],lon0=35,proj=proj1,ex=ex,xe=xe,sx=sx,norm=norm3,cmap=cmapuse,add=1,cbticksize=10,cllw=0.5,nocb=True)
plt.text(lett_plc[0],lett_plc[1],'a.)',ha='left',va='bottom',size=10,transform=ax.transAxes)

################ B
ax = fig.add_axes(rect_ur)
m1 = mcp.shade(xax,yax,sst[159],lon0=35,proj=proj1,ex=ex,xe=xe,sx=sx,norm=norm3,cmap=cmapuse,add=1,cbticksize=10,cllw=0.5,nocb=True)
plt.text(lett_plc[0],lett_plc[1],'b.)',ha='left',va='bottom',size=10,transform=ax.transAxes)

################ C
ax = fig.add_axes(rect_ml)
m1 = mcp.shade(xax,yax,sst[275],lon0=35,proj=proj1,ex=ex,xe=xe,sx=sx,norm=norm3,cmap=cmapuse,add=1,cbticksize=10,cllw=0.5,nocb=True)
plt.text(lett_plc[0],lett_plc[1],'c.)',ha='left',va='bottom',size=10,transform=ax.transAxes)

################ D
ax = fig.add_axes(rect_mr)
m1 = mcp.shade(xax,yax,sst[595],lon0=35,proj=proj1,ex=ex,xe=xe,sx=sx,norm=norm3,cmap=cmapuse,add=1,cbticksize=10,cllw=0.5,nocb=True)
plt.text(lett_plc[0],lett_plc[1],'d.)',ha='left',va='bottom',size=10,transform=ax.transAxes)

################ E
ax = fig.add_axes(rect_ll)
m1 = mcp.shade(xax,yax,sst[1275],lon0=35,proj=proj1,ex=ex,xe=xe,sx=sx,norm=norm3,cmap=cmapuse,add=1,cbticksize=10,cllw=0.5,nocb=True)
plt.text(lett_plc[0],lett_plc[1],'e.)',ha='left',va='bottom',size=10,transform=ax.transAxes)

################ F
ax = fig.add_axes(rect_lr)
m1 = mcp.shade(xax,yax,sst[1875],lon0=35,proj=proj1,ex=ex,xe=xe,sx=sx,norm=norm3,cmap=cmapuse,add=1,cbticksize=10,cllw=0.5,nocb=True)
